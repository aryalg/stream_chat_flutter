...
typedef DownloadedPathCallback = void Function(
    String? path);
  ...
  AttachmentActionsModal copyWith({
    ...
    List<AttachmentAction>? customActions,
      ...
      AttachmentActionsModal(
        ...
        showShowInChat:
            showShowInChat ?? this.showShowInChat,
                  ...
                  if (showSave)
                    _buildButton(
                      ...
                      attachment.type == 'video'
                          ? context
                              .translations.saveVideoLabel
                          : context
                              .translations.saveImageLabel,
                      ...
                      () {
                        ...
                        final Future<String?> Function(
                          ...
                          DownloadedPathCallback
                              downloadedPathCallback,
                        }) saveImage = imageDownloader ??
                            _downloadAttachment;
                        final downloader =
                            isImage ? saveImage : saveFile;
  ...
  Future<String?> _downloadAttachment(
    ...
    await Dio().download(
      ...
      (Headers responseHeaders) {
        ...
        filePath ??=
            '${appDocDir.path}/${attachment.id}.$ext';
        return filePath!;
      },
...
class _DownloadProgress {
  ...
  String get receivedValueInMB =>
      ((received / 1024) / 1024).toStringAsFixed(2);
